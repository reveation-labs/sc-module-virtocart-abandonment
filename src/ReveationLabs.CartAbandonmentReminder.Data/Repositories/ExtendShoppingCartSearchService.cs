...
namespace ReveationLabs.CartAbandonmentReminder.Data.Repositories
{
    ...
    {
        public ExtendShoppingCartSearchService(Func<ICartRepository> repositoryFactory, IPlatformMemoryCache platformMemoryCache, IShoppingCartService cartService) :
